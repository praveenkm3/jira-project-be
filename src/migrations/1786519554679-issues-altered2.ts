...
export class IssuesAltered21786519554679 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."issues_issue_type_enum" AS ENUM('Bug', 'Task', 'Feature')`);
        await queryRunner.query(`ALTER TABLE "issues" ADD "issue_type" "public"."issues_issue_type_enum"`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "issues" DROP COLUMN "issue_type"`);
        await queryRunner.query(`DROP TYPE "public"."issues_issue_type_enum"`);
        await queryRunner.query(`ALTER TABLE "issues" ADD "issue_type" character varying(50) NOT NULL`);
